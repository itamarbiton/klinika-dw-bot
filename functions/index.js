...
exports.botHandler = functions.https.onRequest((req, res) => {
  bot.handleUpdate(req.body, res);
  return
});

exports.handleInform = functions.https.onRequest((req, res) => {
  handleInform(bot);
  res.send('handling inform...');
});

exports.handleRotation = functions.https.onRequest((req, res) => {
  handleRotation();
